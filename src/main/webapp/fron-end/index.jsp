...
<head>
    ...
    <style>
        ...
        .welcome {
            text-align: center;
            padding: 100px 20px;
            background-color: rgba(255, 255, 255, 0.8); /* Light transparent background for the welcome section */
            color: #563d7c;
            font-family: 'Arial', sans-serif;
            border-radius: 10px;
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* Soft shadow for welcome box */
        }
...
<body>
    <!-- New Coffee Menu Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><i class="fa fa-coffee"></i> CoffeeMenu</a>
